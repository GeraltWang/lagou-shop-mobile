...
// 用户信息
const userData = ref({});
const isLogin = computed(() => store.state.user && window.localStorage.getItem('USERTOKEN'));
...
.container {
  ...
  background: radial-gradient(circle at 50% -10%, #199afb 72%, #f6f7f9 72%) #f6f7f9 0 -350px no-repeat;
  .header {
    display: flex;
    // align-items: center;
    margin: 0 15px 15px;
